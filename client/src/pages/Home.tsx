          ...
          <div className="space-y-12">
            ...
            <section className="text-center mb-10">
              <h2 className="text-3xl md:text-5xl font-bold font-display mb-4 tracking-tight">
                <span className="bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">Master Your Numbers</span>
              </h2>
            ...
            <section className="relative z-10">
              <div className="absolute inset-x-0 -top-20 -bottom-20 bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10 -z-10 rounded-[3rem] blur-3xl opacity-60" />
              <Calculator />
            </section>
